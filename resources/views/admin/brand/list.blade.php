    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('brands.create')}}" class="btn btn-primary">Thêm Nhãn Hàng</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="input-group" style="width: 250px;">
                        <input value="{{ Request::get('keyword')}}" type="text" name="keyword" class="form-control float-right" placeholder="Tìm kiếm nhãn hàng">
  ...
  function deleteBrand(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            // Thực hiện gọi API xóa nhãn hàng
