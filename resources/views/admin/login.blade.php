...
<html lang="en">
	...
	<body class="hold-transition login-page">
		<div class="login-box">
			...
			<div class="card card-outline card-primary">
			  	<div class="card-header text-center">
					<a href="#" class="h3">Trang đăng nhập Admin</a>
			  	</div>
			  	<div class="card-body">
					<p class="login-box-msg">Nhập Tài Khoản Email Và Mật Khẩu</p>
		...
		<!-- Bootstrap 4 -->
		<script src="{{asset ('admin_ass/plugins/js/adminlte.min.js') }}"></script>
		<!-- AdminLTE App -->
		<script src="{{asset ('admin_ass/plugins/js/adminlte.min.js') }}"></script>
